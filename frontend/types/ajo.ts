...
export type TokenSymbol = 'USDC' | 'XLM' | 'EURC';

export const TOKEN_ADDRESSES: Record<TokenSymbol, string> = {
  USDC: 'CBIELTK6YBZJU5UP2WWQEUCYKLPU6AUNZ2BQ4WWFEIE3USCIHMXQDAMA',
  XLM:  'CDLZFC3SYJYDZT7K67VZ75HPJVIEUVNIXF47ZG2FB2RMQQVU2HHGCYSC',
  EURC: 'GB3Q6QDZYTHWT7E5PVS3W7FUT5GVAFC5KSZFFLPU25GO575XFT43JMNN',
};

export const STROOPS_PER_UNIT = 10_000_000n;

export function formatAmount(stroops: bigint, symbol: TokenSymbol = 'USDC'): string {
